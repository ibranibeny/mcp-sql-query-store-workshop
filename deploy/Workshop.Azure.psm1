...
function Test-WorkshopReadiness {
    ...
    # are not reported by --list-extensions. Count any recorded built-in extensions toward the exact
    # expected set alongside the marketplace-installed extensions.
    ...
    foreach ($check in @(
        ...
        @{ Name = 'Administration exact tools and extensions'; Passed = (Test-ExactSet -Actual $packageIds -Expected $expectedPackages) -and $packageVersionsObserved -and (Test-ExactSet -Actual $allExtensionIds -Expected $expectedExtensions) -and $dabVersionValid }
