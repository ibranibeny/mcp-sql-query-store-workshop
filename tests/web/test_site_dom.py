...
CLAWPILOT_THEME_CSS = ''':root {
    color-scheme: light;
    --cp-bg: #eaf0f4;
    --cp-bg-elevated: #f4f8fb;
    --cp-surface: #ffffff;
    --cp-surface-soft: #e4ecf2;
    --cp-border: #cdd9e3;
    --cp-border-strong: #8ba0b2;
    --cp-text: #0d1a24;
    --cp-text-muted: #3f596c;
    --cp-text-soft: #5a7284;
    --cp-accent: #0a8f86;
    --cp-accent-hover: #086b64;
    --cp-accent-soft: rgba(10, 143, 134, 0.1);
    --cp-accent-fg: #ffffff;
    --cp-success: #158a3f;
    --cp-danger: #c62828;
    --cp-warning: #a45c00;
    --cp-link: #0066c4;
    --cp-shadow: 0 18px 48px rgba(13, 30, 45, 0.14);
    --cp-overlay: rgba(255, 255, 255, 0.85);
    --cp-panel: rgba(255, 255, 255, 0.88);
    --cp-panel-strong: rgba(255, 255, 255, 0.97);
    --cp-sheen: rgba(10, 143, 134, 0.06);
    --cp-highlight: rgba(10, 143, 134, 0.12);
...
html[data-theme="dark"] {
    color-scheme: dark;
    --cp-bg: #080b11;
    --cp-bg-elevated: #0d121b;
    --cp-surface: #121a25;
    --cp-surface-soft: #18222f;
    --cp-border: #223140;
    --cp-border-strong: #3a4f63;
    --cp-text: #e7f0f7;
    --cp-text-muted: #9db2c4;
    --cp-text-soft: #7b94a8;
    --cp-accent: #35e0d0;
    --cp-accent-hover: #63eee0;
    --cp-accent-soft: rgba(53, 224, 208, 0.14);
    --cp-accent-fg: #04151a;
    --cp-success: #40d867;
    --cp-danger: #ff5b56;
    --cp-warning: #ffb020;
    --cp-link: #4bb4ff;
    --cp-shadow: 0 18px 48px rgba(0, 0, 0, 0.6);
    --cp-overlay: rgba(8, 11, 17, 0.9);
    --cp-panel: rgba(18, 26, 37, 0.72);
    --cp-panel-strong: rgba(18, 26, 37, 0.96);
    --cp-sheen: rgba(53, 224, 208, 0.06);
    --cp-highlight: rgba(53, 224, 208, 0.14);
...
def test_assets_define_exact_clawpilot_theme_typography_and_accessibility_rules(tmp_path: Path) -> None:
    ...
    expected_tokens = {
        "--cp-bg": ("#eaf0f4", "#080b11"),
        "--cp-bg-elevated": ("#f4f8fb", "#0d121b"),
        "--cp-surface": ("#ffffff", "#121a25"),
        "--cp-surface-soft": ("#e4ecf2", "#18222f"),
        "--cp-border": ("#cdd9e3", "#223140"),
        "--cp-border-strong": ("#8ba0b2", "#3a4f63"),
        "--cp-text": ("#0d1a24", "#e7f0f7"),
        "--cp-text-muted": ("#3f596c", "#9db2c4"),
        "--cp-text-soft": ("#5a7284", "#7b94a8"),
        "--cp-accent": ("#0a8f86", "#35e0d0"),
        "--cp-accent-hover": ("#086b64", "#63eee0"),
        "--cp-accent-soft": ("rgba(10, 143, 134, 0.1)", "rgba(53, 224, 208, 0.14)"),
        "--cp-accent-fg": ("#ffffff", "#04151a"),
        "--cp-success": ("#158a3f", "#40d867"),
        "--cp-danger": ("#c62828", "#ff5b56"),
        "--cp-warning": ("#a45c00", "#ffb020"),
        "--cp-link": ("#0066c4", "#4bb4ff"),
    }
