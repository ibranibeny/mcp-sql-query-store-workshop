...
SCENARIO_HEADINGS = [
    (2, "Outcome"),
    (2, "How to run this workshop"),
    (3, "Phase 1. Deploy the environment"),
    (3, "Phase 2. Access path on workshop day"),
    (2, "Safety rules"),
    (2, "Readiness gate"),
    ...
    (3, "A5. Learn the schema with GitHub Copilot"),
    (3, "A6. Inspect the baseline"),
    (3, "A7. Ask GitHub Copilot to explain"),
    (3, "A8. Ground the review with SQL MCP"),
    (3, "A9. Ask GitHub Copilot to optimize"),
